                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="id_unit" id="id_unit" type="text" value="<?= set_value('id_unit'); ?>" />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type = "email" class="form-control" name="email" id="email" type="text" value="<?= set_value('email'); ?>" />
                        </div>
